...
prior = StableCascadePriorPipeline.from_pretrained("/root/models/stable-cascade-prior", torch_dtype=c_dtype)
decoder = StableCascadeDecoderPipeline.from_pretrained("/root/models/stable-cascade", torch_dtype=torch.half)
prior.to(device)
decoder.to(device)
